 ...
 * 
 * The vast majority of this file is copied directly from:
 * https://github.com/trentm/node-bunyan/blob/master/bin/bunyan
 * chanes will be marked with a comment: // bunyan-sift
 * 
...
function siftRecord(rec, opts)
{
    ...
    opts.siftPaths.forEach(function (elements) {
        ...
        if (typeof obj === 'object') {
            delete obj[elements[elements.length - 1]];
        }
    });
}
        ...
        switch (arg) {
            ...
            case '--sift':
                ...
                if (path.length > 0) {
                    ...
                    parsed.siftPaths = parsed.siftPaths || [];
                    parsed.siftPaths.push(pathElements);
                }
                break;
